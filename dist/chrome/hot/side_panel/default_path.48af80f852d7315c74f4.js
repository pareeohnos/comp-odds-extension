...
const calculatOdds = (numberOfTickets, message)=>{
    ...
    if (message.instantWinsLeft > 0) {
        ...
        chanceOfInstantWin = 1 - Math.pow(chanceOfLosing, message.instantWinsLeft);
    }
    return {
        totalCost,
        chanceOfWinning,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bcadff5d2441a0e107a3")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=default_path.48af80f852d7315c74f4.js.map