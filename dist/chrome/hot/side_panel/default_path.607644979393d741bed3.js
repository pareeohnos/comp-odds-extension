...
const calculatOdds = (numberOfTickets, message)=>{
    ...
    if (message.instantWinsLeft > 0) {
        ...
        chanceOfInstantWin = 1 - (chanceOfLosing ^ message.instantWinsLeft);
    }
    return {
        totalCost,
        chanceOfWinning,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("785fa77d8d69d127fc3e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=default_path.607644979393d741bed3.js.map